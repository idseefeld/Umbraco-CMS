...
namespace Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.Core.Components;
...
public class ComponentTests
{
    ...
    public void BrokenRequire()
    {
        ...
        {
            Assert.AreEqual(
                "Broken composer dependency: Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.Core.Components.ComponentTests+Composer2 -> Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.Core.Components.ComponentTests+Composer4.",
                e.Message);
        }
    }
