...
";
    ...
    [TestCase("global::Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.ModelsBuilder.Embedded.BuilderTestsClass1", typeof(BuilderTestsClass1))]
    [TestCase("global::Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.ModelsBuilder.Embedded.BuilderTests.Class1", typeof(Class1))]
    ...
    public void WriteClrTypeUsing(string expected, Type input)
    {
        ...
        builder.Using.Add("Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.ModelsBuilder");
    ...
    public void WriteClrType_Ambiguous2()
    {
        var builder = new TextBuilder();
        builder.Using.Add("System.Text");
        builder.Using.Add("Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.ModelsBuilder.Embedded");
        builder.ModelsNamespaceForTests = "SomeRandomNamespace";
        var sb = new StringBuilder();
        ...
        // note - these assertions differ from the original tests in MB because in the embedded version, the result of Builder.IsAmbiguousSymbol is always true
        // which means global:: syntax will be applied to most things
        Assert.AreEqual("global::Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.ModelsBuilder.Embedded.ASCIIEncoding", sb.ToString());
    }
    ...
    public void WriteClrType_AmbiguousNot()
    {
        ...
        builder.Using.Add("System.Text");
        builder.Using.Add("Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.ModelsBuilder.Embedded");
        builder.ModelsNamespaceForTests = "Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.ModelsBuilder.Models";
        var sb = new StringBuilder();
        builder.WriteClrType(sb, typeof(ASCIIEncoding));
    ...
    public void WriteClrType_AmbiguousWithNested()
    {
        ...
        // note - these assertions differ from the original tests in MB because in the embedded version, the result of Builder.IsAmbiguousSymbol is always true
        // which means global:: syntax will be applied to most things
        Assert.AreEqual("global::Umbraco.Cms.Tests.UnitTests.PostgreSql.Umbraco.ModelsBuilder.Embedded.ASCIIEncoding.Nested", sb.ToString());
    }
