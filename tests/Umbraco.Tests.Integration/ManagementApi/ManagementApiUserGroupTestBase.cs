    ...
    where T : ManagementApiControllerBase
{
    ...
    public virtual async Task As_Admin_I_Have_Specified_Access()
    {
        ...
        Assert.AreEqual(AdminUserGroupAssertionModel.ExpectedStatusCode, response.StatusCode, content);
    }
    ...
    public virtual async Task As_Editor_I_Have_Specified_Access()
    {
        ...
        var content = await response.Content.ReadAsStringAsync();
        Assert.AreEqual(EditorUserGroupAssertionModel.ExpectedStatusCode, response.StatusCode, content);
    }
    ...
    public virtual async Task As_Sensitive_Data_I_Have_Specified_Access()
    {
        ...
        var content = await response.Content.ReadAsStringAsync();
        Assert.AreEqual(SensitiveDataUserGroupAssertionModel.ExpectedStatusCode, response.StatusCode, content);
    }
    ...
    public virtual async Task As_Translator_I_Have_Specified_Access()
    {
        ...
        var content = await response.Content.ReadAsStringAsync();
        Assert.AreEqual(TranslatorUserGroupAssertionModel.ExpectedStatusCode, response.StatusCode, content);
    }
    ...
    public virtual async Task As_Writer_I_Have_Specified_Access()
    {
        ...
        var content = await response.Content.ReadAsStringAsync();
        Assert.AreEqual(WriterUserGroupAssertionModel.ExpectedStatusCode, response.StatusCode, content);
    }
    ...
    public virtual async Task As_Unauthorized_I_Have_Specified_Access()
    {
        ...
        var content = await response.Content.ReadAsStringAsync();
        Assert.AreEqual(UnauthorizedUserGroupAssertionModel.ExpectedStatusCode, response.StatusCode, content);
    }
