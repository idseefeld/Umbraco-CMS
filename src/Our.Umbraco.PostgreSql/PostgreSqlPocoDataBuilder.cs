...
/// <summary>
///     PostgreSql's implementation of NPoco <see cref="PocoDataBuilder" />.
/// </summary>
/// <remarks>
///     <para>
...
/// </remarks>
internal class PostgreSqlPocoDataBuilder : PocoDataBuilder
{
    private readonly bool _upgrading;

    public PostgreSqlPocoDataBuilder(Type type, MapperCollection? mapper, bool upgrading)
        : base(type, mapper) =>
