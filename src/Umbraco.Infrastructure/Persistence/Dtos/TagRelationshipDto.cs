...
internal sealed class TagRelationshipDto
{
    ...
    public const string PrimaryKeyConstraintName = "PK_cmsTagRelationship";
    ...
    [PrimaryKeyColumn(AutoIncrement = false, Name = PrimaryKeyConstraintName, OnColumns = $"{NodeIdColumnName}, {PropertyTypeIdColumnName}, {TagIdColumnName}")]
