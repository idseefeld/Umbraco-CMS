...
public class UserGroup2LanguageDto
{
    ...
    public const string PrimaryKeyConstraintName = "PK_userGroup2language";
    ...
    [PrimaryKeyColumn(AutoIncrement = false, Name = PrimaryKeyConstraintName, OnColumns = $"{UserGroupIdColumnName}, {LanguageIdColumnName}")]
